...
(async function oneko() {
    ...
    function create() {
        ...
        nekoEl.style.backgroundImage = `url('https://web.archive.org/web/20240130174013/https://raw.githubusercontent.com/kyrie25/spicetify-oneko/main/assets/oneko/oneko-${variant}.gif')`;
    ...
    function setVariant(arr) {
        ...
        nekoEl.style.backgroundImage = `url('https://web.archive.org/web/20240130174013/https://raw.githubusercontent.com/kyrie25/spicetify-oneko/main/assets/oneko/oneko-${arr}.gif')`;
    }
